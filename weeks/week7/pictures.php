...
<tr>
    <td><img src="/it261/images/<?php echo substr( $image, 0, 5);?>1.jpg" alt="<?php echo str_replace( '_', ' ', $name);?>"></td>
    <td><?php echo str_replace( '_', ' ', $name)                                                                       ;?></td>
    <td><?php echo substr( $image, 6)                                                                                  ;?></td>
    <td><img src="/it261/images/<?php echo substr( $image, 0, 5);?>2.jpg" alt="<?php echo str_replace( '_', ' ', $name);?>"></td>
</tr>
<?php endforeach       ;?>
</table>
</body>
